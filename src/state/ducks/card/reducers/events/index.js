...
const reducer = handleActions(
  {
    [`${types.API_SEARCH_EVENTS}_SUCCESS`]: success
  },
  INITIAL_STATE
);

const loadable = withLoadable(types.API_SEARCH_EVENTS);
const reset = withResetState(types.RESET_EVENTS, INITIAL_STATE);
