...
const reducer = handleActions(
  {
    [`${types.API_SEARCH_SERIES}_SUCCESS`]: success
  },
  INITIAL_STATE
);

const loadable = withLoadable(types.API_SEARCH_SERIES);
const reset = withResetState(types.RESET_SERIES, INITIAL_STATE);
